...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_WPN_SECONDARYATTACK, AE_TYPE_CLIENT | AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_WPN_MELEEATTACK, AE_TYPE_CLIENT | AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_WPN_FRAGATTACK, AE_TYPE_CLIENT | AE_TYPE_SERVER );
