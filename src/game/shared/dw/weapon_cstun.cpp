...
ConVar    sk_plr_dmg_cstun("sk_plr_dmg_cstun", "0", FCVAR_REPLICATED);
ConVar    sk_npc_dmg_cstun("sk_npc_dmg_cstun", "0", FCVAR_REPLICATED);
...
float CWeaponCstun::GetDamageForActivity(Activity hitActivity)
{
	...
	return sk_npc_dmg_cstun.GetFloat();
}
