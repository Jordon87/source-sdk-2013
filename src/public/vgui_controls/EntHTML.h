...
namespace vgui
{
	...
	public:
		...
		EntHTML(Panel* parent, const char* name, bool allowJavaScript = false, bool bPopupWindow = false);
		~EntHTML();
	...
	private:
		STEAM_CALLBACK(EntHTML, BrowserNeedsPaint, HTML_NeedsPaint_t, m_NeedsPaint);
		STEAM_CALLBACK(EntHTML, BrowserComboNeedsPaint, HTML_ComboNeedsPaint_t, m_ComboNeedsPaint);
		STEAM_CALLBACK(EntHTML, BrowserStartRequest, HTML_StartRequest_t, m_StartRequest);
		STEAM_CALLBACK(EntHTML, BrowserURLChanged, HTML_URLChanged_t, m_URLChanged);
		STEAM_CALLBACK(EntHTML, BrowserFinishedRequest, HTML_FinishedRequest_t, m_FinishedRequest);
		STEAM_CALLBACK(EntHTML, BrowserShowPopup, HTML_ShowPopup_t, m_ShowPopup);
		STEAM_CALLBACK(EntHTML, BrowserHidePopup, HTML_HidePopup_t, m_HidePopup);
		STEAM_CALLBACK(EntHTML, BrowserSizePopup, HTML_SizePopup_t, m_SizePopup);

		STEAM_CALLBACK(EntHTML, BrowserOpenNewTab, HTML_OpenLinkInNewTab_t, m_LinkInNewTab);
		STEAM_CALLBACK(EntHTML, BrowserSetHTMLTitle, HTML_ChangedTitle_t, m_ChangeTitle);
		STEAM_CALLBACK(EntHTML, BrowserPopupHTMLWindow, HTML_NewWindow_t, m_NewWindow);
		STEAM_CALLBACK(EntHTML, BrowserFileLoadDialog, HTML_FileOpenDialog_t, m_FileLoadDialog);
		STEAM_CALLBACK(EntHTML, BrowserSearchResults, HTML_SearchResults_t, m_SearchResults);
		STEAM_CALLBACK(EntHTML, BrowserClose, HTML_CloseBrowser_t, m_CloseBrowser);
		STEAM_CALLBACK(EntHTML, BrowserHorizontalScrollBarSizeResponse, HTML_HorizontalScroll_t, m_HorizScroll);
		STEAM_CALLBACK(EntHTML, BrowserVerticalScrollBarSizeResponse, HTML_VerticalScroll_t, m_VertScroll);
		STEAM_CALLBACK(EntHTML, BrowserLinkAtPositionResponse, HTML_LinkAtPosition_t, m_LinkAtPosResp);
		STEAM_CALLBACK(EntHTML, BrowserJSAlert, HTML_JSAlert_t, m_JSAlert);
		STEAM_CALLBACK(EntHTML, BrowserJSConfirm, HTML_JSConfirm_t, m_JSConfirm);
		STEAM_CALLBACK(EntHTML, BrowserCanGoBackandForward, HTML_CanGoBackAndForward_t, m_CanGoBackForward);
		STEAM_CALLBACK(EntHTML, BrowserSetCursor, HTML_SetCursor_t, m_SetCursor);
		STEAM_CALLBACK(EntHTML, BrowserStatusText, HTML_StatusText_t, m_StatusText);
		STEAM_CALLBACK(EntHTML, BrowserShowToolTip, HTML_ShowToolTip_t, m_ShowTooltip);
		STEAM_CALLBACK(EntHTML, BrowserUpdateToolTip, HTML_UpdateToolTip_t, m_UpdateTooltip);
		STEAM_CALLBACK(EntHTML, BrowserHideToolTip, HTML_HideToolTip_t, m_HideTooltip);
		...
		class CEntHTMLFindBar : public vgui::EditablePanel
		{
			DECLARE_CLASS_SIMPLE(CEntHTMLFindBar, EditablePanel);
		public:
			CEntHTMLFindBar(EntHTML* parent);
		...
		private:
			...
			vgui::EntHTML* m_pParent;
			vgui::Label* m_pFindCountLabel;
			bool m_bHidden;
		};

		CEntHTMLFindBar* m_pFindBar;
		EntHTMLComboBoxHost* m_pComboBoxHost;
		...
		CCallResult< EntHTML, HTML_BrowserReady_t > m_SteamCallResultBrowserReady;
	};
