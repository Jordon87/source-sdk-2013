...
LINK_ENTITY_TO_CLASS(npc_bullsquid, CHoe_NPC_Bullsquid);
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC(CHoe_NPC_Bullsquid)
...
//=========================================================
void CHoe_NPC_Bullsquid::Precache()
{
...
// Output : 
//-----------------------------------------------------------------------------
Class_T	CHoe_NPC_Bullsquid::Classify(void)
{
...
void CHoe_NPC_Bullsquid::IdleSound(void)
{
...
// PainSound 
//=========================================================
void CHoe_NPC_Bullsquid::PainSound(const CTakeDamageInfo &info)
{
...
// AlertSound
//=========================================================
void CHoe_NPC_Bullsquid::AlertSound(void)
{
...
// DeathSound
//=========================================================
void CHoe_NPC_Bullsquid::DeathSound(const CTakeDamageInfo &info)
{
...
// AttackSound
//=========================================================
void CHoe_NPC_Bullsquid::AttackSound(void)
{
...
// GrowlSound
//=========================================================
void CHoe_NPC_Bullsquid::GrowlSound(void)
{
...
//=========================================================
float CHoe_NPC_Bullsquid::MaxYawSpeed(void)
{
	float flYS = 0;
...
//=========================================================
void CHoe_NPC_Bullsquid::HandleAnimEvent(animevent_t *pEvent)
{
	switch (pEvent->event)
	{
	case BSQUID_AE_SPIT:
...
//-----------------------------------------------------------------------------
bool CHoe_NPC_Bullsquid::HandleInteraction(int interactionType, void *data, CBaseCombatCharacter *sender)
{
...
int CHoe_NPC_Bullsquid::RangeAttack1Conditions(float flDot, float flDist)
{
...
//=========================================================
int CHoe_NPC_Bullsquid::MeleeAttack1Conditions(float flDot, float flDist)
{
...
// is valid.
//=========================================================
int CHoe_NPC_Bullsquid::MeleeAttack2Conditions(float flDot, float flDist)
{
...
bool CHoe_NPC_Bullsquid::FValidateHintType(CAI_Hint *pHint)
{
...
void CHoe_NPC_Bullsquid::RemoveIgnoredConditions(void)
{
...
Disposition_t CHoe_NPC_Bullsquid::IRelationType(CBaseEntity *pTarget)
{
...
//=========================================================
int CHoe_NPC_Bullsquid::OnTakeDamage_Alive(const CTakeDamageInfo &inputInfo)
{
...
//=========================================================
int CHoe_NPC_Bullsquid::GetSoundInterests(void)
{
	return	SOUND_WORLD |
		SOUND_COMBAT |
		SOUND_CARCASS |
...
//=========================================================
void CHoe_NPC_Bullsquid::OnListened(void)
{
	AISoundIter_t iter;
...
//========================================================
void CHoe_NPC_Bullsquid::RunAI(void)
{
...
// GetSchedule 
//=========================================================
int CHoe_NPC_Bullsquid::SelectSchedule(void)
{
	switch (m_NPCState)
	{
...
//=========================================================
bool CHoe_NPC_Bullsquid::FInViewCone(Vector pOrigin)
{
...
//=========================================================
void CHoe_NPC_Bullsquid::StartTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
// RunTask
//=========================================================
void CHoe_NPC_Bullsquid::RunTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
	case TASK_SQUID_HOPTURN:
...
//=========================================================
NPC_STATE CHoe_NPC_Bullsquid::SelectIdealState(void)
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CHoe_NPC_Bullsquid::SeenEnemyWithinTime(float flTime)
{
...
//-----------------------------------------------------------------------------
bool CHoe_NPC_Bullsquid::InnateWeaponLOSCondition(const Vector &ownerPos, const Vector &targetPos, bool bSetConditions)
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CHoe_NPC_Bullsquid::GetSpitVector(const Vector &vecStartPos, const Vector &vecTarget, Vector *vecOut)
{
...
// Input  : flDuration - 
//-----------------------------------------------------------------------------
void CHoe_NPC_Bullsquid::DelaySquadAttack(float flDuration)
{
	if (GetSquad())
	{
...
AI_BEGIN_CUSTOM_NPC(npc_bullsquid, CHoe_NPC_Bullsquid)
