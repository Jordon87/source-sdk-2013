...
#ifndef HOE_NPC_BULLSQUID_H
#define HOE_NPC_BULLSQUID_H

#include "ai_basenpc.h"


class CHoe_NPC_Bullsquid : public CAI_BaseNPC
{
	DECLARE_CLASS(CHoe_NPC_Bullsquid, CAI_BaseNPC);
	DECLARE_DATADESC();
