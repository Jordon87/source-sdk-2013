...
// CHoe_NPC_Houndeye
//=========================================================
LINK_ENTITY_TO_CLASS(npc_houndeye, CHoe_NPC_Houndeye);

BEGIN_DATADESC(CHoe_NPC_Houndeye)
...
// relationship table.
//=========================================================
Class_T	CHoe_NPC_Houndeye::Classify(void)
{
...
// Output :
//-----------------------------------------------------------------------------
int CHoe_NPC_Houndeye::RangeAttack1Conditions(float flDot, float flDist)
{
...
// Output :
//-----------------------------------------------------------------------------
int CHoe_NPC_Houndeye::GetSoundInterests(void)
{
	return	SOUND_WORLD |
		SOUND_COMBAT |
		SOUND_PLAYER |
...
//=========================================================
float CHoe_NPC_Houndeye::MaxYawSpeed(void)
{
	int ys = 90;
...
//=========================================================
void CHoe_NPC_Houndeye::HandleAnimEvent(animevent_t *pEvent)
{
	switch (pEvent->event)
	{
	case HOUND_AE_WARN:
...
//=========================================================
void CHoe_NPC_Houndeye::Precache()
{
...
// Output  :
//------------------------------------------------------------------------------
void CHoe_NPC_Houndeye::SpeakSentence(int sentenceType)
{
...
// IdleSound
//=========================================================
void CHoe_NPC_Houndeye::IdleSound(void)
{
	if (!FOkToMakeSound())
	{
		return;
...
// IdleSound
//=========================================================
void CHoe_NPC_Houndeye::WarmUpSound(void)
{
...
// WarnSound 
//=========================================================
void CHoe_NPC_Houndeye::WarnSound(void)
{
...
// AlertSound 
//=========================================================
void CHoe_NPC_Houndeye::AlertSound(void)
{
...
// DeathSound 
//=========================================================
void CHoe_NPC_Houndeye::DeathSound(const CTakeDamageInfo& info)
{
...
// PainSound 
//=========================================================
void CHoe_NPC_Houndeye::PainSound(const CTakeDamageInfo& info)
{
...
//=========================================================
void CHoe_NPC_Houndeye::WriteBeamColor(void)
{
...
//-----------------------------------------------------------------------------
void CHoe_NPC_Houndeye::NPCThink(void)
{
#if 0
	if (m_pEnergyWave)
	{
...
// Output  :
//------------------------------------------------------------------------------
int CHoe_NPC_Houndeye::OnTakeDamage_Alive(const CTakeDamageInfo &info)
{
...
// Output  :
//------------------------------------------------------------------------------
void CHoe_NPC_Houndeye::Event_Killed(const CTakeDamageInfo &info)
{
	EmitSound("NPC_Houndeye.Retreat");
	m_flSoundWaitTime = gpGlobals->curtime + 1.0;
...
// SonicAttack
//=========================================================
void CHoe_NPC_Houndeye::SonicAttack(void)
{
...
// start task
//=========================================================
void CHoe_NPC_Houndeye::StartTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
#if 1
			if (GetNavigator()->SetRadialGoal(vTargetPos, WorldSpaceCenter(), random->RandomFloat(50, 500), 90, 175, m_bLoopClockwise))
#else
			if (GetNavigator()->SetRadialGoal(vTargetPos, random->Random(50, 500), 90, 175, m_bLoopClockwise))
#endif
			{
				TaskComplete();
				return;
...
// RunTask 
//=========================================================
void CHoe_NPC_Houndeye::RunTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
	case TASK_HOUND_THREAT_DISPLAY:
...
// Output  :
//------------------------------------------------------------------------------
void CHoe_NPC_Houndeye::PrescheduleThink(void)
{
...
// Output :
//-----------------------------------------------------------------------------
Activity CHoe_NPC_Houndeye::NPC_TranslateActivity(Activity eNewActivity)
{
...
// Output  :
//------------------------------------------------------------------------------
int CHoe_NPC_Houndeye::TranslateSchedule(int scheduleType)
{
	switch (scheduleType)
	{
...
// Output  :
//------------------------------------------------------------------------------
bool CHoe_NPC_Houndeye::IsAnyoneInSquadAttacking(void)
{
	if (!m_pSquad)
	{
		return false;
...
// SelectSchedule
//=========================================================
int CHoe_NPC_Houndeye::SelectSchedule(void)
{
	switch (m_NPCState)
	{
	case NPC_STATE_IDLE:
...
//-----------------------------------------------------------------------------
bool CHoe_NPC_Houndeye::HandleInteraction(int interactionType, void *data, CBaseCombatCharacter* sourceEnt)
{
...
AI_BEGIN_CUSTOM_NPC( npc_houndeye, CHoe_NPC_Houndeye )
