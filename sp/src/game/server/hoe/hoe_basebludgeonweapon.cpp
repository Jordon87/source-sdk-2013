...
IMPLEMENT_SERVERCLASS_ST( CHoe_BaseBludgeonWeapon, DT_Hoe_BaseBludgeonWeapon )
END_SEND_TABLE()
...
// Constructor
//-----------------------------------------------------------------------------
CHoe_BaseBludgeonWeapon::CHoe_BaseBludgeonWeapon()
{
...
//-----------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::Spawn(void)
{
	m_fMinRange1	= 0;
	m_fMinRange2	= 0;
	m_fMaxRange1	= 64;
...
//-----------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::Precache(void)
{
	//Call base class first
	BaseClass::Precache();
}

int CHoe_BaseBludgeonWeapon::CapabilitiesGet()
{ 
	return bits_CAP_WEAPON_MELEE_ATTACK1; 
}


int CHoe_BaseBludgeonWeapon::WeaponMeleeAttack1Condition(float flDot, float flDist)
{
	if (flDist > 64)
	{
...
//------------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::ItemPostFrame(void)
{
...
// Output  :
//------------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::PrimaryAttack()
{
	Swing( false );
}
...
// Output  :
//------------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::SecondaryAttack()
{
	Swing( true );
}
...
//------------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::Hit(trace_t &traceHit, Activity nHitActivity, bool bIsSecondary)
{
...
// Input  : &traceHit - 
//-----------------------------------------------------------------------------
bool CHoe_BaseBludgeonWeapon::ImpactWater(const Vector &start, const Vector &end)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::ImpactEffect(trace_t &traceHit)
{
...
//------------------------------------------------------------------------------
void CHoe_BaseBludgeonWeapon::Swing(int bIsSecondary)
{
	trace_t traceHit;
