...
IMPLEMENT_SERVERCLASS_ST( CHoe_MachineGun, DT_Hoe_MachineGun )
END_SEND_TABLE()

//=========================================================
//	>> CHoe_MachineGun
//=========================================================
BEGIN_DATADESC( CHoe_MachineGun )
...
// Purpose: 
//-----------------------------------------------------------------------------
CHoe_MachineGun::CHoe_MachineGun(void)
{
}

const Vector &CHoe_MachineGun::GetBulletSpread(void)
{
...
//
//-----------------------------------------------------------------------------
void CHoe_MachineGun::PrimaryAttack(void)
{
...
// Input  : &info - 
//-----------------------------------------------------------------------------
void CHoe_MachineGun::FireBullets(const FireBulletsInfo_t &info)
{
...
//-----------------------------------------------------------------------------
int CHoe_MachineGun::WeaponRangeAttack1Condition(float flDot, float flDist)
{
	if ( m_iClip1 <=0 )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHoe_MachineGun::DoMachineGunKick(CBasePlayer *pPlayer, float dampEasy, float maxVerticleKickAngle, float fireDurationTime, float slideLimitTime)
{
...
//-----------------------------------------------------------------------------
bool CHoe_MachineGun::Deploy(void)
{
	m_nShotsFired = 0;
...
//-----------------------------------------------------------------------------
int CHoe_MachineGun::WeaponSoundRealtime(WeaponSound_t shoot_type)
{
	int numBullets = 0;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHoe_MachineGun::ItemPostFrame(void)
{
...
IMPLEMENT_SERVERCLASS_ST( CHoe_SelectFireMachineGun, DT_Hoe_SelectFireMachineGun )
END_SEND_TABLE()
...
BEGIN_DATADESC( CHoe_SelectFireMachineGun )
...
float CHoe_SelectFireMachineGun::GetBurstCycleRate(void)
{
...
float CHoe_SelectFireMachineGun::GetFireRate(void)
{
	switch( m_iFireMode )
	{
...
bool CHoe_SelectFireMachineGun::Deploy(void)
{
...
//
//-----------------------------------------------------------------------------
void CHoe_SelectFireMachineGun::PrimaryAttack(void)
{
	if (m_bFireOnEmpty)
	{
		return;
	...
	case FIREMODE_3RNDBURST:
		...
		BurstThink();
		SetThink( &CHoe_SelectFireMachineGun::BurstThink );
...
//
//-----------------------------------------------------------------------------
void CHoe_SelectFireMachineGun::SecondaryAttack( void )
{
	// change fire modes.
...
//
//-----------------------------------------------------------------------------
void CHoe_SelectFireMachineGun::BurstThink(void)
{
	CHoe_MachineGun::PrimaryAttack();
...
//
//-----------------------------------------------------------------------------
void CHoe_SelectFireMachineGun::WeaponSound(WeaponSound_t shoot_type, float soundtime /*= 0.0f*/)
{
...
//-----------------------------------------------------------------------------
int CHoe_SelectFireMachineGun::WeaponRangeAttack1Condition(float flDot, float flDist)
{
	if (m_iClip1 <=0)
	{
		return COND_NO_PRIMARY_AMMO;
...
//-----------------------------------------------------------------------------
int CHoe_SelectFireMachineGun::WeaponRangeAttack2Condition(float flDot, float flDist)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHoe_SelectFireMachineGun::CHoe_SelectFireMachineGun(void)
{
	m_fMinRange1	= 65;
	m_fMinRange2	= 65;
	m_fMaxRange1	= 1024;
