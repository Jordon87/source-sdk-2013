...
class CTriageWeaponBugBait : public CBaseTriageCombatWeapon
{
	DECLARE_CLASS( CTriageWeaponBugBait, CBaseTriageCombatWeapon );
public:

	DECLARE_SERVERCLASS();

	CTriageWeaponBugBait( void );
...
IMPLEMENT_SERVERCLASS_ST(CTriageWeaponBugBait, DT_TriageWeaponBugBait)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_bugbait, CTriageWeaponBugBait );

BEGIN_DATADESC(CTriageWeaponBugBait)
...
// Purpose: 
//-----------------------------------------------------------------------------
CTriageWeaponBugBait::CTriageWeaponBugBait(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::Spawn(void)
{
	BaseClass::Spawn();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::FallInit(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::Precache(void)
{
	BaseClass::Precache();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::Drop(const Vector &vecVelocity)
{
	...
	SetTouch(&CTriageWeaponBugBait::BugbaitStickyTouch);
...
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::BugbaitStickyTouch(CBaseEntity *pOther)
{
	if ( !pOther->IsWorld() )
		return;
...
// Input  : *pPicker - 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::OnPickedUp(CBaseCombatCharacter *pNewOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::PrimaryAttack(void)
{
	if ( m_bRedraw )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::SecondaryAttack(void)
{
	// Squeeze!
...
// Input  : *pPlayer - 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::ThrowGrenade(CBasePlayer *pPlayer)
{
...
//			*pOperator - 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
	switch( pEvent->event )
	{
...
//-----------------------------------------------------------------------------
bool CTriageWeaponBugBait::Reload(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::ItemPostFrame(void)
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTriageWeaponBugBait::Deploy(void)
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTriageWeaponBugBait::Holster(CBaseCombatWeapon *pSwitchingTo)
{
	m_bRedraw = false;
	m_bDrawBackFinished = false;
...
// Input  : true - 
//-----------------------------------------------------------------------------
void CTriageWeaponBugBait::SetSporeEmitterState(bool state)
{
	m_bEmitSpores = state;
}
