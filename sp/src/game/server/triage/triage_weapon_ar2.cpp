...
BEGIN_DATADESC( CTriageWeaponAR2 )
...
IMPLEMENT_SERVERCLASS_ST(CTriageWeaponAR2, DT_TriageWeaponAR2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_ar2, CTriageWeaponAR2);

acttable_t	CTriageWeaponAR2::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CTriageWeaponAR2);

CTriageWeaponAR2::CTriageWeaponAR2()
{
	m_fMinRange1	= 65;
	m_fMaxRange1	= 2048;
...
void CTriageWeaponAR2::Precache(void)
{
	BaseClass::Precache();
...
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::ItemPostFrame(void)
{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CTriageWeaponAR2::GetPrimaryAttackActivity(void)
{
...
//			nDamageType - 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::DoImpactEffect(trace_t &tr, int nDamageType)
{
	CEffectData data;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::DelayedAttack(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::SecondaryAttack(void)
{
	if ( m_bShotDelayed )
		return;
...
//-----------------------------------------------------------------------------
bool CTriageWeaponAR2::CanHolster(void)
{
	if ( m_bShotDelayed )
		return false;
...
// Purpose: Override if we're waiting to release a shot
//-----------------------------------------------------------------------------
bool CTriageWeaponAR2::Reload(void)
{
	if ( m_bShotDelayed )
		return false;
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::FireNPCSecondaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
	WeaponSound( WPN_DOUBLE );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
	if ( bSecondary )
	{
...
//			*pOperator - 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch( pEvent->event )
	{ 
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageWeaponAR2::AddViewKick(void)
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CTriageWeaponAR2::GetProficiencyValues()
{
