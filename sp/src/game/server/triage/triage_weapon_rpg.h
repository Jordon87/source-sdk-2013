...
#ifndef TRIAGE_WEAPON_RPG_H
#define TRIAGE_WEAPON_RPG_H
...
//###########################################################################
//	>> CTriageMissile		(missile launcher class is below this one!)
//###########################################################################
class CTriageMissile : public CBaseCombatCharacter
{
	DECLARE_CLASS( CTriageMissile, CBaseCombatCharacter );
...
public:
	...
	CHandle<CTriageWeaponRPG>		m_hOwner;

	static CTriageMissile *Create( const Vector &vecOrigin, const QAngle &vecAngles, edict_t *pentOwner );
...
// RPG
//-----------------------------------------------------------------------------
class CTriageWeaponRPG : public CBaseTriageCombatWeapon
{
	DECLARE_CLASS(CTriageWeaponRPG, CBaseTriageCombatWeapon);
public:
