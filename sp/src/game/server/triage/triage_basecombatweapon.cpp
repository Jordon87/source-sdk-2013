...
IMPLEMENT_SERVERCLASS_ST( CTriageMachineGun, DT_TriageMachineGun )
END_SEND_TABLE()

//=========================================================
//	>> CTriageMachineGun
//=========================================================
BEGIN_DATADESC( CTriageMachineGun )
...
// Purpose: 
//-----------------------------------------------------------------------------
CTriageMachineGun::CTriageMachineGun( void )
{
}

const Vector &CTriageMachineGun::GetBulletSpread( void )
{
...
//
//-----------------------------------------------------------------------------
void CTriageMachineGun::PrimaryAttack( void )
{
...
// Input  : &info - 
//-----------------------------------------------------------------------------
void CTriageMachineGun::FireBullets( const FireBulletsInfo_t &info )
{
...
//-----------------------------------------------------------------------------
int CTriageMachineGun::WeaponRangeAttack1Condition( float flDot, float flDist )
{
	if ( m_iClip1 <=0 )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageMachineGun::DoMachineGunKick( CBasePlayer *pPlayer, float dampEasy, float maxVerticleKickAngle, float fireDurationTime, float slideLimitTime )
{
...
//-----------------------------------------------------------------------------
bool CTriageMachineGun::Deploy( void )
{
	m_nShotsFired = 0;
...
//-----------------------------------------------------------------------------
int CTriageMachineGun::WeaponSoundRealtime( WeaponSound_t shoot_type )
{
	int numBullets = 0;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTriageMachineGun::ItemPostFrame( void )
{
...
IMPLEMENT_SERVERCLASS_ST( CTriageSelectFireMachineGun, DT_TriageSelectFireMachineGun )
END_SEND_TABLE()
...
BEGIN_DATADESC( CTriageSelectFireMachineGun )
...
float CTriageSelectFireMachineGun::GetBurstCycleRate( void )
{
...
float CTriageSelectFireMachineGun::GetFireRate( void )
{
	switch( m_iFireMode )
	{
...
bool CTriageSelectFireMachineGun::Deploy( void )
{
...
//
//-----------------------------------------------------------------------------
void CTriageSelectFireMachineGun::PrimaryAttack( void )
{
	if (m_bFireOnEmpty)
	{
		return;
	...
	case FIREMODE_3RNDBURST:
		...
		BurstThink();
		SetThink( &CTriageSelectFireMachineGun::BurstThink );
...
//
//-----------------------------------------------------------------------------
void CTriageSelectFireMachineGun::SecondaryAttack( void )
{
	// change fire modes.
...
//
//-----------------------------------------------------------------------------
void CTriageSelectFireMachineGun::BurstThink( void )
{
	CTriageMachineGun::PrimaryAttack();
...
//
//-----------------------------------------------------------------------------
void CTriageSelectFireMachineGun::WeaponSound( WeaponSound_t shoot_type, float soundtime /*= 0.0f*/ )
{
...
//-----------------------------------------------------------------------------
int CTriageSelectFireMachineGun::WeaponRangeAttack1Condition( float flDot, float flDist )
{
	if (m_iClip1 <=0)
	{
		return COND_NO_PRIMARY_AMMO;
...
//-----------------------------------------------------------------------------
int CTriageSelectFireMachineGun::WeaponRangeAttack2Condition( float flDot, float flDist )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTriageSelectFireMachineGun::CTriageSelectFireMachineGun( void )
{
	m_fMinRange1	= 65;
	m_fMinRange2	= 65;
	m_fMaxRange1	= 1024;
