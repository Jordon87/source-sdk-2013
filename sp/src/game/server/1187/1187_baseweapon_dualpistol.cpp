...
BEGIN_DATADESC(C1187_BaseWeapon_DualPistol)
...
C1187_BaseWeapon_DualPistol::C1187_BaseWeapon_DualPistol()
{
	m_iClipLeft = 0;
	m_iClipRight = 0;
...
int C1187_BaseWeapon_DualPistol::GetMaxClipLeft() const
{
	return GetMaxClip1() / 2;
}

int C1187_BaseWeapon_DualPistol::GetMaxClipRight() const
{
	return GetMaxClip1() / 2;
}

bool C1187_BaseWeapon_DualPistol::Deploy(void)
{
...
//-----------------------------------------------------------------------------
void C1187_BaseWeapon_DualPistol::FinishReload(void)
{
...
void C1187_BaseWeapon_DualPistol::ItemPostFrame(void)
{
...
void C1187_BaseWeapon_DualPistol::PrimaryAttack(void)
{
...
void C1187_BaseWeapon_DualPistol::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
void C1187_BaseWeapon_DualPistol::DoFire(CBaseCombatCharacter* pOperator, Vector vecAiming, bool bSecondary)
{
	if (!pOperator)
		return;
