...
class C1187_NPC_BaseZombie_Headless : public CAI_BlendingHost<CNPC_BaseZombie>, public CDefaultPlayerPickupVPhysics
{
	DECLARE_DATADESC();
	DECLARE_CLASS(C1187_NPC_BaseZombie_Headless, CAI_BlendingHost<CNPC_BaseZombie>);
...
public:
	...
	HeadcrabRelease_t ShouldReleaseHeadcrab(const CTakeDamageInfo &info, float flDamageThreshold) { return RELEASE_NO; }
