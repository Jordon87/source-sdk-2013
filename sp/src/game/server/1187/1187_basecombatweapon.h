...
#ifndef ELEVENEIGHTYSEVEN_BASECOMBATWEAPON_H
#define ELEVENEIGHTYSEVEN_BASECOMBATWEAPON_H
#ifdef _WIN32
#pragma once
#endif
...
//=========================================================
abstract_class C1187MachineGun : public CBase1187CombatWeapon
{
public:
	DECLARE_CLASS( C1187MachineGun, CBase1187CombatWeapon );
	DECLARE_DATADESC();
...
//=========================================================
class C1187SelectFireMachineGun : public C1187MachineGun
{
	DECLARE_CLASS(C1187SelectFireMachineGun, C1187MachineGun);
public:

	C1187SelectFireMachineGun(void);
...
#endif // ELEVENEIGHTYSEVEN_BASECOMBATWEAPON_H
