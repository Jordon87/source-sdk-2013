...
BEGIN_DATADESC(C1187_NPC_BaseZombie_Headless_Runner)
...
//---------------------------------------------------------
//---------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::pMoanSounds[] =
{
	"ATV_engine_null",
};

void C1187_NPC_BaseZombie_Headless_Runner::Spawn(void)
{
	Precache();
...
void C1187_NPC_BaseZombie_Headless_Runner::Precache(void)
{
	BaseClass::Precache();
...
void C1187_NPC_BaseZombie_Headless_Runner::SetZombieModel(void)
{
...
void C1187_NPC_BaseZombie_Headless_Runner::PrescheduleThink(void)
{
...
void C1187_NPC_BaseZombie_Headless_Runner::OnScheduleChange(void)
{
...
Activity C1187_NPC_BaseZombie_Headless_Runner::NPC_TranslateActivity(Activity baseAct)
{
...
bool C1187_NPC_BaseZombie_Headless_Runner::AllowedToSprint(void)
{
	if (IsOnFire())
		return false;
...
void C1187_NPC_BaseZombie_Headless_Runner::StopSprint(void)
{
...
void C1187_NPC_BaseZombie_Headless_Runner::Sprint(bool bMadSprint)
{
	if (IsSprinting())
		return;
...
void C1187_NPC_BaseZombie_Headless_Runner::RunTask(const Task_t *pTask)
{
	switch (pTask->iTask)
	{
...
void C1187_NPC_BaseZombie_Headless_Runner::InputStartSprint(inputdata_t &inputdata)
{
	Sprint();
}
...
//-----------------------------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::GetMoanSound(int nSound)
{
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::FootstepSound(bool fRightFoot)
{
	if (fRightFoot)
	{
...
//-----------------------------------------------------------------------------
bool C1187_NPC_BaseZombie_Headless_Runner::ShouldBecomeTorso(const CTakeDamageInfo &info, float flDamageThreshold)
{
	return false;
}
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::FootscuffSound(bool fRightFoot)
{
	if (fRightFoot)
	{
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::AttackHitSound(void)
{
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::AttackMissSound(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::PainSound(const CTakeDamageInfo &info)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::DeathSound(const CTakeDamageInfo &info)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::AlertSound(void)
{
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::IdleSound(void)
{
...
//-----------------------------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::AttackSound(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::GetHeadcrabModel(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::GetLegsModel(void)
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::GetTorsoModel(void)
{
...
//---------------------------------------------------------
void C1187_NPC_BaseZombie_Headless_Runner::MoanSound(envelopePoint_t *pEnvelope, int iEnvelopeSize)
{
	if (IsOnFire())
	{
...
//-----------------------------------------------------------------------------
const char *C1187_NPC_BaseZombie_Headless_Runner::GetHeadcrabClassname(void)
{
	return "npc_headcrab";
}
...
AI_BEGIN_CUSTOM_NPC(npc_basezombie_headless_runner, C1187_NPC_BaseZombie_Headless_Runner)
