...
static DynamicResupplyItems_t g_DynamicResupplyAmmoItems[] =
{
	...
	{ "weapon_manhack",				"Manhack",		SIZE_AMMO_MANHACK,		0.0f },
	{ "weapon_smokegrenade",		"SmokeGrenade", 1,						0.0f },
#endif
};
...
#if defined ( HUMANERROR_DLL )
	DEFINE_KEYFIELD(m_flDesiredAmmo[10], FIELD_FLOAT, "DesiredAmmoManhack"),
	DEFINE_KEYFIELD(m_flDesiredAmmo[11], FIELD_FLOAT, "DesiredAmmoSmokeGrenade"),
#endif
...
#if defined (HUMANERROR_DLL)
	m_flDesiredAmmo[10] = 0;	// Manhack
	m_flDesiredAmmo[11] = 0;
#endif
}
