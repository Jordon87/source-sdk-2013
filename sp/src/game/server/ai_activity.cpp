...
//===========================
	...
	// Tripmine
	ADD_ACTIVITY_TO_SR(ACT_VM_TRIPMINE_ARM1);
	ADD_ACTIVITY_TO_SR(ACT_VM_TRIPMINE_GROUND);
	ADD_ACTIVITY_TO_SR(ACT_VM_TRIPMINE_PLACE);
	ADD_ACTIVITY_TO_SR(ACT_VM_TRIPMINE_WORLD);
