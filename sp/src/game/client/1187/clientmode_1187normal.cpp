...
//
// Purpose: Draws the normal 1187 HUD.
//
//=============================================================================
#include "cbase.h"
...
{
	static ClientMode1187Normal g_ClientModeNormal;
...
//-----------------------------------------------------------------------------
ClientMode1187Normal::ClientMode1187Normal()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ClientMode1187Normal::Init()
{
	BaseClass::Init();
...
bool ClientMode1187Normal::ShouldDrawCrosshair( void )
{
