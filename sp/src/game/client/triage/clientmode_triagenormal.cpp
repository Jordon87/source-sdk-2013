...
//
// Purpose: Draws the normal Triage HUD.
//
//=============================================================================
#include "cbase.h"
...
{
	static ClientModeTriageNormal g_ClientModeNormal;
...
//-----------------------------------------------------------------------------
ClientModeTriageNormal::ClientModeTriageNormal()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ClientModeTriageNormal::Init()
{
	BaseClass::Init();
...
bool ClientModeTriageNormal::ShouldDrawCrosshair( void )
{
