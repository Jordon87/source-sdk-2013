...
//===========================
	...
	// Tripmine
	REGISTER_SHARED_ACTIVITY(ACT_VM_TRIPMINE_ARM1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_TRIPMINE_GROUND);
	REGISTER_SHARED_ACTIVITY(ACT_VM_TRIPMINE_PLACE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_TRIPMINE_WORLD);
