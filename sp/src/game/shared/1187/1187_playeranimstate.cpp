...
// Purpose: 
//-----------------------------------------------------------------------------
void C1187PlayerAnimState::Update()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C1187PlayerAnimState::ComputePlaybackRate()
{
...
// Input  : dt - 
//-----------------------------------------------------------------------------
void C1187PlayerAnimState::EstimateYaw(void)
{
...
// Input  : dt - 
//-----------------------------------------------------------------------------
void C1187PlayerAnimState::ComputePoseParam_BodyYaw(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C1187PlayerAnimState::ComputePoseParam_BodyPitch(CStudioHdr *pStudioHdr)
{
...
// Output : int
//-----------------------------------------------------------------------------
int C1187PlayerAnimState::ConvergeAngles(float goal, float maxrate, float dt, float& current)
{
...
void C1187PlayerAnimState::ComputePoseParam_BodyLookYaw(void)
{
	QAngle absangles = GetOuter()->GetAbsAngles();
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity C1187PlayerAnimState::BodyYawTranslateActivity(Activity activity)
{
...
const QAngle& C1187PlayerAnimState::GetRenderAngles()
{
	return m_angRender;
}


void C1187PlayerAnimState::GetOuterAbsVelocity(Vector& vel)
{
